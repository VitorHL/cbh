...
define skill_catharsis_loc = "sentiment"
define skill_volition_loc = "volition"
define skill_lore_loc = "acuity"
...
define skill_catharsis_quote = "\"The heart has its reasons which reason knows nothing of.\"\n\n- Blaise Pascal -"
define skill_volition_quote = "\"He who has a why to live can bear almost any how.\"\n\n- Friedrich Nietzsche -"
define skill_lore_quote = "\"The question is not what you look at, but what you see.\"\n\n- Henry David Thoreau -"
...
define skill_catharsis_desc = "Sentiment governs your capacity for genuine feeling and emotional depth. A high level of sentiment makes you responsive to beauty, moved by suffering, and attuned to atmosphere, experiencing life with emotional authenticity rather than detachment or cynicism."
...
define skill_lore_desc = "Acuity governs the sharpness and precision of your observation. A high level of acuity allows you to notice fine details others overlook, catch subtle changes in your environment, and perceive the world with exceptional clarity and focus."
