...
define skill_communion_desc = "Communion governs your capacity to form meaningful connections and empathize with others. A high level of communion allows you to build trust quickly, understand unspoken feelings, and create bonds that transcend surface-level social interaction.\n\nThis skill activates when building a genuine human connection matters. Use it to comfort someone in distress, break through emotional walls, or make another person feel truly seen and understood. Where Sentiment lets you perceive emotion, Communion lets you reach across the gap and touch it. People open up to those who make them feel safe and Communion is what makes them feel safe with you."
...
define skill_sentiment_desc = "Sentiment governs your capacity for genuine feeling and emotional depth. A high level of sentiment makes you responsive to beauty, moved by suffering, and attuned to atmosphere, experiencing life with emotional authenticity rather than detachment or cynicism.\n\nThis skill activates when emotional understanding matters more than intellectual analysis. Use it to read someone's grief beneath their composure, to feel the weight of tragedy rather than merely cataloging it, or to respond to others with genuine feeling instead of performed concern. Low Sentiment means seeing sadness without feeling sad. High Sentiment means the world's suffering becomes your own."
