...
#                     xsize 500
#                     yminimum 16
#                     text "{size=20} [mission.name_loc]" yminimum 16
#                     vbox:
#                         yminimum 16
#                         xpos 20
#                         for objv in mission.objectives:
#                             fixed:
#                                 xsize 500
#                                 ysize 20
#                                 if objv.complete == True:
#                                     text "{size=16}* {color=#00ff00}(Completed){/color} [objv.name_loc]"
#                                 if objv.failed == True:
#                                     text "{size=16}* {color=#f00}(Failed){/color} [objv.name_loc]"
#                                 if objv.complete == False:
#                                     text "{size=16}* [objv.name_loc]"
        ...
        frame:
            ...
            vbox:
                ...
                button style "select_button_menu" xsize 250:
                    ...
                    #action ShowMenu("history")
                button style "select_button_menu" xsize 250:
                    text ">EPISODES" style "pause_menu_button_text"
                    #action ShowMenu("history")
                button style "select_button_menu" xsize 250:
